...
<a4h5.986L31.525 0z"
          ...
          <LogoContainer>
            {/* <Logo src="/images/icon-facebook.svg" alt="facebook" />
            <Logo src="/images/icon-youtube.svg" alt="youtube" />
            <Logo src="/images/icon-twitter.svg" alt="twitter" />
            <Logo src="/images/icon-pinterest.svg" alt="pinterest" />
            <Logo src="/images/icon-instagram.svg" alt="instagram" /> */}
